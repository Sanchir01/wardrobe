...
const ReviewCart = ({ alt, image, text, title, rating }: IReviewCartProps) => {
	...
	return (
		<div
			className={cn(
				'p-5 bg-white max-w-[350px] max-h-[264px] shrink-0 flex-none w-2/9 rounded-lg transition-all duration-200 shadow-xl max-[998px]:w-1/3 max-[768px]:w-1/2 max-[576px]:w-3/4',
